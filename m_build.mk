...
quiet_cmd_defconfig     = DEFCONFIG  $@
      cmd_defconfig     = cp configs/boards/$(CONFIG_BOARDNAME)/proj_$(CONFIG_PROJ_NAME)/$@ .config && $(CONF) $(CONF_ARGS) Kconfig

quiet_cmd_listdefconfig = LISTDEFS   $@
cmd_listdefconfig = find  configs/boards/$(CONFIG_BOARDNAME)/proj_$(CONFIG_PROJ_NAME)/ -type f -iname '*_defconfig' | sed -e "s:^configs/boards/$(CONFIG_BOARDNAME)/proj_$(CONFIG_PROJ_NAME)/::g" |sort
